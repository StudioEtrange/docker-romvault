...
This is a Docker container for [ROMVault](https://www.romvault.com/).
...
## Table of Content
   ...
   * [Docker container for Romvault](#docker-container-for-romvault)
...
Where:
  - `/docker/appdata/romvault`: This is where the application stores its configuration, log and any files needing persistency. This folder will also contains a computer folder which is a link to the root of the container to help access the whole tree folder from within the windows interface.
...
```
docker pull studioetrange/romvault
```
...
container image.
  ...
  3.  In the search bar, type the name of the container (`studioetrange/romvault`).
